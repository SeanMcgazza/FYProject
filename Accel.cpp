...
//    float deltaZ = 0;
    ...
    acc.enable();
    //printf("\r\n\nFXOS8700Q Who Am I= %X\r", acc.whoAmI());
    ...
    while (true) 
    {
        ...
        printf("    MAG1: X=%4.1f Y=%4.1f Z=%4.1f\r", mag_data.x, mag_data.y, mag_data.z);//printing out X,Y,Z Axis of Magn.
      
      printf("The value of x is: %f",x);
       mag.getX(&fmX);
      printf("    MAG: X =%4.1f\r", fmX);
      printf("FMX = %f", fmX);
